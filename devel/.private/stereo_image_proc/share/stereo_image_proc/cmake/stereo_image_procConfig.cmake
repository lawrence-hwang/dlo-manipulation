...
if("TRUE" STREQUAL "TRUE")
  set(stereo_image_proc_SOURCE_PREFIX /home/drojas/lawrence_wire/src/image_pipeline/stereo_image_proc)
  set(stereo_image_proc_DEVEL_PREFIX /home/drojas/lawrence_wire/devel/.private/stereo_image_proc)
  ...
  set(stereo_image_proc_INSTALL_PREFIX /home/drojas/lawrence_wire/install)
...
if(NOT "/home/drojas/lawrence_wire/devel/.private/stereo_image_proc/include;/home/drojas/lawrence_wire/src/image_pipeline/stereo_image_proc/include " STREQUAL " ")
  set(stereo_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/drojas/lawrence_wire/devel/.private/stereo_image_proc/include;/home/drojas/lawrence_wire/src/image_pipeline/stereo_image_proc/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://www.ros.org/wiki/stereo_image_proc " STREQUAL " ")
    set(_report "Check the website 'http://www.ros.org/wiki/stereo_image_proc' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/drojas/lawrence_wire/src/image_pipeline/stereo_image_proc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT stereo_image_proc_NUM_DUMMY_TARGETS)
      set(stereo_image_proc_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::stereo_image_proc::wrapped-linker-option${stereo_image_proc_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR stereo_image_proc_NUM_DUMMY_TARGETS "${stereo_image_proc_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::stereo_image_proc::wrapped-linker-option${stereo_image_proc_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND stereo_image_proc_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/drojas/lawrence_wire/devel/.private/stereo_image_proc/lib;/home/drojas/lawrence_wire/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${stereo_image_proc_dep}_FOUND)
      find_package(${stereo_image_proc_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${stereo_image_proc_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(stereo_image_proc_EXPORTED_TARGETS ${${stereo_image_proc_dep}_EXPORTED_TARGETS})
endforeach()
