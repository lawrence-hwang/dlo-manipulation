...
namespace stereo_image_proc
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(DisparityConfig &config, const DisparityConfig &max, const DisparityConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const DisparityConfig &config1, const DisparityConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, DisparityConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const DisparityConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, DisparityConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const DisparityConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const DisparityConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, DisparityConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(DisparityConfig::AbstractParamDescriptionConstPtr(new DisparityConfig::ParamDescription<int>("stereo_algorithm", "int", 0, "stereo algorithm", "{'enum': [{'name': 'StereoBM', 'type': 'int', 'value': 0, 'srcline': 11, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg', 'description': 'Block Matching', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'StereoSGBM', 'type': 'int', 'value': 1, 'srcline': 12, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg', 'description': 'SemiGlobal Block Matching', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'stereo algorithm'}", &DisparityConfig::stereo_algorithm)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 11 "/home/drojas/lawrence_wire/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg"
      const int Disparity_StereoBM = 0;
//#line 12 "/home/drojas/lawrence_wire/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg"
