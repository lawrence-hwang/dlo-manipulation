...
namespace image_proc
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(ResizeConfig &config, const ResizeConfig &max, const ResizeConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const ResizeConfig &config1, const ResizeConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, ResizeConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const ResizeConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, ResizeConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const ResizeConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const ResizeConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, ResizeConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ResizeConfig::AbstractParamDescriptionConstPtr(new ResizeConfig::ParamDescription<int>("interpolation", "int", 0, "Interpolation algorithm between source image pixels", "{'enum': [{'name': 'NN', 'type': 'int', 'value': 0, 'srcline': 11, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Nearest neighbor', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Linear', 'type': 'int', 'value': 1, 'srcline': 12, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Linear', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Cubic', 'type': 'int', 'value': 2, 'srcline': 13, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Cubic', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Lanczos4', 'type': 'int', 'value': 4, 'srcline': 14, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Lanczos4', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'interpolation type'}", &ResizeConfig::interpolation)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(ResizeConfig::AbstractParamDescriptionConstPtr(new ResizeConfig::ParamDescription<int>("interpolation", "int", 0, "Interpolation algorithm between source image pixels", "{'enum': [{'name': 'NN', 'type': 'int', 'value': 0, 'srcline': 11, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Nearest neighbor', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Linear', 'type': 'int', 'value': 1, 'srcline': 12, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Linear', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Cubic', 'type': 'int', 'value': 2, 'srcline': 13, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Cubic', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Lanczos4', 'type': 'int', 'value': 4, 'srcline': 14, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Lanczos4', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'interpolation type'}", &ResizeConfig::interpolation)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.use_scale = 0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.use_scale = 1;
...
//#line 11 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_NN = 0;
//#line 12 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_Linear = 1;
//#line 13 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_Cubic = 2;
//#line 14 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Resize.cfg"
