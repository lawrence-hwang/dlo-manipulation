...
namespace image_proc
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(DebayerConfig &config, const DebayerConfig &max, const DebayerConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const DebayerConfig &config1, const DebayerConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, DebayerConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const DebayerConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, DebayerConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const DebayerConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const DebayerConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, DebayerConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(DebayerConfig::AbstractParamDescriptionConstPtr(new DebayerConfig::ParamDescription<int>("debayer", "int", 0, "Debayering algorithm", "{'enum': [{'name': 'Bilinear', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Fast algorithm using bilinear interpolation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAware', 'type': 'int', 'value': 1, 'srcline': 11, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAwareWeighted', 'type': 'int', 'value': 2, 'srcline': 13, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Weighted edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VNG', 'type': 'int', 'value': 3, 'srcline': 15, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Slow but high quality Variable Number of Gradients algorithm', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Debayering algorithm'}", &DebayerConfig::debayer)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(DebayerConfig::AbstractParamDescriptionConstPtr(new DebayerConfig::ParamDescription<int>("debayer", "int", 0, "Debayering algorithm", "{'enum': [{'name': 'Bilinear', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Fast algorithm using bilinear interpolation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAware', 'type': 'int', 'value': 1, 'srcline': 11, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAwareWeighted', 'type': 'int', 'value': 2, 'srcline': 13, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Weighted edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VNG', 'type': 'int', 'value': 3, 'srcline': 15, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Slow but high quality Variable Number of Gradients algorithm', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Debayering algorithm'}", &DebayerConfig::debayer)));
...
//#line 9 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg"
      const int Debayer_Bilinear = 0;
//#line 11 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg"
      const int Debayer_EdgeAware = 1;
//#line 13 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg"
      const int Debayer_EdgeAwareWeighted = 2;
//#line 15 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Debayer.cfg"
