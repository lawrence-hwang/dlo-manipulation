...
namespace image_proc
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(RectifyConfig &config, const RectifyConfig &max, const RectifyConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const RectifyConfig &config1, const RectifyConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, RectifyConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const RectifyConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, RectifyConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const RectifyConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const RectifyConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, RectifyConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RectifyConfig::AbstractParamDescriptionConstPtr(new RectifyConfig::ParamDescription<int>("interpolation", "int", 0, "Interpolation algorithm between source image pixels", "{'enum': [{'name': 'NN', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Rectify.cfg', 'description': 'Nearest neighbor', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Linear', 'type': 'int', 'value': 1, 'srcline': 10, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Rectify.cfg', 'description': 'Linear', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Cubic', 'type': 'int', 'value': 2, 'srcline': 11, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Rectify.cfg', 'description': 'Cubic', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Lanczos4', 'type': 'int', 'value': 4, 'srcline': 12, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Rectify.cfg', 'description': 'Lanczos4', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'interpolation type'}", &RectifyConfig::interpolation)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_NN = 0;
//#line 10 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_Linear = 1;
//#line 11 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_Cubic = 2;
//#line 12 "/home/drojas/lawrence_wire/src/image_pipeline/image_proc/cfg/Rectify.cfg"
