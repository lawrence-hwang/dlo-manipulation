...
namespace image_view
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(ImageViewConfig &config, const ImageViewConfig &max, const ImageViewConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const ImageViewConfig &config1, const ImageViewConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, ImageViewConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const ImageViewConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, ImageViewConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const ImageViewConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const ImageViewConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, ImageViewConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ImageViewConfig::AbstractParamDescriptionConstPtr(new ImageViewConfig::ParamDescription<int>("colormap", "int", 0, "colormap", "{'enum': [{'name': 'NO_COLORMAP', 'type': 'int', 'value': -1, 'srcline': 9, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'NO_COLORMAP', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'AUTUMN', 'type': 'int', 'value': 0, 'srcline': 10, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_AUTUMN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'BONE', 'type': 'int', 'value': 1, 'srcline': 11, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_BONE', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'JET', 'type': 'int', 'value': 2, 'srcline': 12, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_JET', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WINTER', 'type': 'int', 'value': 3, 'srcline': 13, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_WINTER', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'RAINBOW', 'type': 'int', 'value': 4, 'srcline': 14, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_RAINBOW', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'OCEAN', 'type': 'int', 'value': 5, 'srcline': 15, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_OCEAN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'SUMMER', 'type': 'int', 'value': 6, 'srcline': 16, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_SUMMER', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'SPRING', 'type': 'int', 'value': 7, 'srcline': 17, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_SPRING', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'COOL', 'type': 'int', 'value': 8, 'srcline': 18, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_COOL', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'HSV', 'type': 'int', 'value': 9, 'srcline': 19, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_HSV', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'PINK', 'type': 'int', 'value': 10, 'srcline': 20, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_PINK', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'HOT', 'type': 'int', 'value': 11, 'srcline': 21, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_HOT', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'colormap'}", &ImageViewConfig::colormap)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(ImageViewConfig::AbstractParamDescriptionConstPtr(new ImageViewConfig::ParamDescription<int>("colormap", "int", 0, "colormap", "{'enum': [{'name': 'NO_COLORMAP', 'type': 'int', 'value': -1, 'srcline': 9, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'NO_COLORMAP', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'AUTUMN', 'type': 'int', 'value': 0, 'srcline': 10, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_AUTUMN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'BONE', 'type': 'int', 'value': 1, 'srcline': 11, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_BONE', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'JET', 'type': 'int', 'value': 2, 'srcline': 12, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_JET', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WINTER', 'type': 'int', 'value': 3, 'srcline': 13, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_WINTER', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'RAINBOW', 'type': 'int', 'value': 4, 'srcline': 14, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_RAINBOW', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'OCEAN', 'type': 'int', 'value': 5, 'srcline': 15, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_OCEAN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'SUMMER', 'type': 'int', 'value': 6, 'srcline': 16, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_SUMMER', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'SPRING', 'type': 'int', 'value': 7, 'srcline': 17, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_SPRING', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'COOL', 'type': 'int', 'value': 8, 'srcline': 18, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_COOL', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'HSV', 'type': 'int', 'value': 9, 'srcline': 19, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_HSV', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'PINK', 'type': 'int', 'value': 10, 'srcline': 20, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_PINK', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'HOT', 'type': 'int', 'value': 11, 'srcline': 21, 'srcfile': '/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg', 'description': 'COLORMAP_HOT', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'colormap'}", &ImageViewConfig::colormap)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_NO_COLORMAP = -1;
//#line 10 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_AUTUMN = 0;
//#line 11 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_BONE = 1;
//#line 12 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_JET = 2;
//#line 13 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_WINTER = 3;
//#line 14 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_RAINBOW = 4;
//#line 15 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_OCEAN = 5;
//#line 16 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_SUMMER = 6;
//#line 17 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_SPRING = 7;
//#line 18 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_COOL = 8;
//#line 19 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_HSV = 9;
//#line 20 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_PINK = 10;
//#line 21 "/home/drojas/lawrence_wire/src/image_pipeline/image_view/cfg/ImageView.cfg"
