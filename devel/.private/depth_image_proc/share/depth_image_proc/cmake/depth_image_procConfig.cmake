...
if("TRUE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX /home/drojas/lawrence_wire/src/image_pipeline/depth_image_proc)
  set(depth_image_proc_DEVEL_PREFIX /home/drojas/lawrence_wire/devel/.private/depth_image_proc)
  ...
  set(depth_image_proc_INSTALL_PREFIX /home/drojas/lawrence_wire/install)
...
if(NOT "/home/drojas/lawrence_wire/src/image_pipeline/depth_image_proc/include " STREQUAL " ")
  set(depth_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/drojas/lawrence_wire/src/image_pipeline/depth_image_proc/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/drojas/lawrence_wire/src/image_pipeline/depth_image_proc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/drojas/lawrence_wire/devel/.private/depth_image_proc/lib;/home/drojas/lawrence_wire/devel/lib;/opt/ros/noetic/lib)
...
set(depends "image_geometry;sensor_msgs")
